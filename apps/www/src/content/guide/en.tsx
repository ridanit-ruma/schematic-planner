  ...
  └─ Project   one thing you are building
       └─ Plan one graph`}</pre>
        ...
        <p>
          ...
          <strong>feature</strong> and a <strong>task</strong> are solid, a{' '}
          <strong>decision</strong> has a clipped corner, a <strong>note</strong> is dashed, and a{' '}
          <strong>group</strong> is drawn as a boundary around whatever it holds.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            <strong>Contains</strong> — drag from the container to what goes inside it. This is what
