...
export const meta: PageMeta = {
  title: 'Schematic Planner — plan in the browser, own the output',
  description:
    ...
    <>
      ...
      <Band>
        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          ...
          <Link href={localePath('en', '/guide')} className="text-sm text-accent underline">
