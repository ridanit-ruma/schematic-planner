...
- **Authorship.** The maintainer is the sole author of every commit and PR. No
  ...
  slipped in.
  The GitHub tools a cloud session uses to open or edit a PR append a "Generated by
  Claude Code" footer with a session link on their own: read the PR body back after
  every create or update and edit the footer out.
